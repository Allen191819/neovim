...
lang["jakewvincent/mkdnflow.nvim"] = {opt=true, ft="markdown",config=conf.markdown_flow}
-- lang['daeyun/vim-matlab'] = { opt=true,ft="matlab",run="UpdateRemotePlugins",config=conf.matlab }
return lang
